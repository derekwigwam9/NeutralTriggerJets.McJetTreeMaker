...
class StMcJetTreeMaker {
  ...
  private:
    ...
    Int_t    _PrimaryTrackArray_geantId[NTrkMax];
    Int_t    _PrimaryTrackArray_pdgId[NTrkMax];
    ...
    Float_t  _TowerArray_TwrMatchDphi[NTwrMax];
    Float_t  _TowerArray_TwrMatchDEta[NTwrMax];
    Float_t  _TowerArray_TwrMatchP[NTwrMax];
    Int_t    _TowerArray_TwrMatchIndexOfTrack[NTwrMax];
    ...
    TArrayI  _TowerArray_fMatchedTracks[NTwrMax];
    ...
    TBranch *_bTowerArray_TwrMatchDphi;
    TBranch *_bTowerArray_TwrMatchDEta;
    TBranch *_bTowerArray_TwrMatchP;
    TBranch *_bTowerArray_TwrMatchIndexOfTrack;
    TBranch *_bTowerArray_TwrPx;
    TBranch *_bTowerArray_TwrPy;
    TBranch *_bTowerArray_TwrPz;
    TBranch *_bTowerArray_fNAssocTracks;
    TBranch *_bTowerArray_fMatchedTracks;
